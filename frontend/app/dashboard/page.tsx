...
export default function DashboardPage() {
  return (
    <div className="relative flex min-h-screen w-full flex-col">
      <header className="sticky top-0 z-10 flex items-center justify-between whitespace-nowrap border-b border-solid border-divider bg-background-dark/80 px-4 py-3 backdrop-blur-sm sm:px-6 md:px-10">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          <a
            className="text-text-primary text-sm font-medium leading-normal relative after:absolute after:bottom-[-4px] after:left-0 after:h-[2px] after:w-full after:bg-primary after:content-['']"
            href="#"
          >
            Overview
          </a>
          <a
            className="text-text-muted hover:text-text-primary transition-colors text-sm font-medium leading-normal"
            href="#"
          >
            Signals
          </a>
        ...
        <div className="flex items-center gap-4">
          <button className="text-text-muted hover:text-text-primary md:hidden">
